import timeit
# Bu değerlerden yukarısını çalıştırma RAM yetmiyor.
...
def sanitise_1(data):  # Sıralı listeler için yazdığımız kod
...
def sanitise_2(data):  # enumerate ve reversed metodu
